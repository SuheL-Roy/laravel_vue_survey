    ...
    <div class="flex justify-between items-center mt-3">
      ...
      <div class="flex items-center">
        <a
          ...
          target="_blank"
          class="h-8 w-8 flex items-center justify-center rounded-full border border-transparent text-sm text-gray-500 focus:ring-2 focus:ring-offset-3 focus:ring-green-500"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
